...
async function store(req,res){
    try{
        ...
        res.redirect("/admin/users")
            ...
            errorMessage:{
             password:"Invalid Password. It must contain atleast 1 Upper Case charecter,1 Lower Case charecter 1 Digit"
            },data:data
        })
    }
    else{
...
async function edit(req,res){
    try{
        ...
        res.render("admin/user/edit",{title:"Admin User Section",data:data,error:{}})
